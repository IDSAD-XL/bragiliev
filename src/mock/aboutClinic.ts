...
export const aboutClinicContent: IAboutClinicContent = {
  ...
  aboutClinicBlocks: [
    ...
    },
    {
      ...
      additionally: {
        text: 'За 20 лет «Grandmed» стала клиникой мечты не только для её создателей и сотрудников, но и для пациентов.',
        subtext:
    ...
    },
    {
      ...
      desc: [
        {
          text: 'Хирурги «Grandmed» одни из первых делали глубокую подтяжку лица, после которой не требовалось никаких повязок. Они одни из первых делали увеличение груди через разрез около пупка. Они в числе первых начали в операционной работать в тандеме с косметологами, которые тут применяют лазер или Альтеру. Уловив новый тренд, они также в числе первых стали внедрять технологию по обработки жировой ткани для последующего её использования в качестве филлера.',
        },
      ],
      noPadBottom: true,
    },
